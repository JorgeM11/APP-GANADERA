...
export default function PrimaryButton({
  ...
  if (isDisabled) {
    ...
    variantClasses = "bg-primary text-on-primary shadow-[0_4px_20px_rgba(23,52,24,0.3)] hover:bg-[#1e4520] hover:shadow-[0_6px_24px_rgba(23,52,24,0.38)] active:scale-[0.98] cursor-pointer";
  } else {
